...
public class ConfigCollectionTest {
    ...
    public void entryStream() {
        ...
        assertSame(serviceRanking, serviceRankingEntry.configStream(ServiceRanking.class).findFirst().orElseThrow());
        ...
        assertSame(serviceVendor, serviceVendorEntry.configStream(ServiceVendor.class).findFirst().orElseThrow());
